                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('bills.store') }}">
                            ...
                            <div class="form-group row">
                                <label for="role" class="col-md-4 col-form-label text-md-right">Selected Room
                                    Category</label>
                                <div class="col-md-6">
                                    <select name="category_id" class="form-select form-select-sm">
                                        <option value="{{ $roomCategories->id }}">{{ $roomCategories->category_name }}
                                        </option>
                                    </select>
                                </div>
                            </div>
                            <br>
                            <div class="form-group row">
                                <label for="name" class="col-md-4 col-form-label text-md-right">Date Start*
                                    (dd-mm-YYYY)</label>
                                <div class="col-md-6">
                                    <input id="date_start" value="{{ old('date_start') }}" name="date_start" type="text"
                            ...
                            <br>
                            <div class="form-group row">
                                <label for="name" class="col-md-4 col-form-label text-md-right">Date Finish*
                                    (dd-mm-YYYY)</label>
                                <div class="col-md-6">
                                    <input id="date_finish" value="{{ old('date_start') }}" name="date_finish" type="text"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="ID_Card" value="{{ old('ID_Card') }}" name="ID_Card" type="text"
